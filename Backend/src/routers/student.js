...
router.get('/students/:studentId/:siteName/:startYear-:endYear/examSchedule', auth(['Student', 'InLocoParent']),
        ...
        try {
            let classroomSchedule = await SchoolClass.findAll({
                ...
                where: {startYear: req.params.startYear, endYear: req.params.endYear}, attributes: ['id'], include: {
                    ...
                    attributes: ['id'],
                    where: {id: req.studentInClass.classroomId},
                    include: {
                        association: 'examSchedules', attributes: ['id'], include: {
                            association: 'scheduledExams',
